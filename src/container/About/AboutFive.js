                    ...
                    <div className="col-xl-5 col-lg-6 col-12" data-aos="fade-up" data-aos-delay="300">
                        <div className="about-content-area">
                            <SectionTitleTwo 
                                ...
                                title="We’ve worked with plenty of startups to develop their &amp; brand"
                            />
                            ...
                            <Link className="btn btn-primary btn-hover-secondary mt-xl-12 mt-lg-8 mt-md-6 mt-4" to={process.env.PUBLIC_URL + "/contact"}>Find Us</Link>
                        </div>
                    </div>
