    ...
    return (
        <div className="footer-section section footer-bg-color">
            <div className="container">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 col-12 mb-6">
                        <div className="footer-widget">
                            <div className="footer-logo">
                                <Logo 
                                    image={`${process.env.PUBLIC_URL}/images/logo/logotop.png`}
                                />
                            </div>
                            <div className="footer-widget-content">
                                <div className="content">
                                    ...
                                    <p><Link to={process.env.PUBLIC_URL + "/"}>(+1) 415-398-4000</Link></p>
                                    <p><Link to={process.env.PUBLIC_URL + "/"}>design@seaclifftech.com</Link> </p>
                                </div>
                ...
                <div className="row">
                    <div className="col">
                        <p className="copyright">&copy; 2021 <strong>This website</strong> Made with <i className="fas fa-heart text-danger"></i> by <a target="_blank" rel="noopener noreferrer" href="https://stakr.xyz/"><strong>Joshua Bernstein</strong></a>.</p>
                    </div>
                </div>
